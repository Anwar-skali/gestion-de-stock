...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="{{ route('dashboard.index') }}">Gestion de Stock</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            @else
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('client.login') }}">Connexion Client</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('client.register') }}">Inscription Client</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('login') }}">Connexion Admin</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('register') }}">Inscription Admin</a>
                    </li>
                </ul>
            @endauth
        </div>
